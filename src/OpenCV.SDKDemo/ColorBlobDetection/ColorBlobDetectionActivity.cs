...
namespace OpenCV.SDKDemo.ColorBlobDetection
{
    ...
    public class ColorBlobDetectionActivity : Activity, View.IOnTouchListener, ICvCameraViewListener2
    {
    ...
    public ColorBlobDetectionActivity() {
        Log.Info(ActivityTags.ColorBlobDetection, "Instantiated new " + this.getClass());
    }
    ...
    public override void OnCreate(Bundle savedInstanceState) {
        ...
        Window.AddFlags(WindowFlags.KeepScreenOn);
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        if (mIsColorSelected) {
            ...
            Log.Error(ActivityTags.ColorBlobDetection, "Contours count: " + contours.size());
